...
\textbf{Backend:}  Node.js, Express, Django, Golang & \textbf{Design:}  Figma, Framer, Canva \\
\textbf{Database:}  MongoDB, Firebase, PostgreSQL & \textbf{AI/ML:} Pytorch, RAG, Scikit-Learn \\
\textbf{Cloud:} Git, Docker, GCP, Jenkins, AWS  & \textbf{Tools:} Postman, n8n, Jira, Vercel, Render \\
\end{tabular}
...
BRAC University, Dhaka & \hfill & \textbf{} \\[20pt] 
...
    \textbf{Stacks: }Node.js, Typescript, Tailwind, Firebase (Auth \& DataBase)
}  \\
\end{tabularx}
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
\textbf{\textbullet\ NORTHERN PARIBAHAN - Bus Ticketing Site} & \hfill \href{https://northern-paribahan.vercel.app/}{\hspace{0.5em} \faLight\faLink} \\[3.75pt]
\multicolumn{2}{@{}X@{}}{%
Production ready Full-stack system featuring secure User Authentication, Dynamic routes \& schedules, Live seat selection \& a robust Admin Control for managing inventory, fares, \& sales analytics.
    \newline % Creates a new line
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
\textbf{\textbullet\ SCREEN BOX - Movie Streaming Site} & \hfill \href{https://screen-box.vercel.app/}{\hspace{0.5em} \faLight\faLink} \\[3.75pt]
\multicolumn{2}{@{}X@{}}{%
...
\begin{multicols}{2}
\begin{itemize}[leftmargin=*, nosep, itemsep=3.5pt, parsep=0pt] % Minimal vertical spacing
